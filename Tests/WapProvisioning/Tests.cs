...
namespace OmaSharp.Tests.WapProvisioning
{
    ...
    public class Tests
    {
        ...
        [Test]
        public void ImsiSemiOctetSwap()
        {
            var imsi = 425021234567890;
            //var expected = "24051232547698F0";
            var expected = "4952202143658709";
            var imsiGsmBytes = imsi.SwapBcdBytes();
            Assert.AreEqual(expected, imsiGsmBytes.ToHexStringCompact());
        }
    }
}